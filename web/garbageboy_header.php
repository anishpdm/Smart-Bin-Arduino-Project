    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li><a href="garbageboy_viewgraph.php">View Bin</a></li>

                <li><a href="garbageboy_binmaps.php">Map View</a></li>
                <li><a href="garbageboy_route.php"> Best Route For Clean the Bin </a></li>
